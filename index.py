...
def extract_resume_info(text):
    ...
    Format the output as a JSON object with the above fields. Ensure that Professional Experience, Projects, and Questions and Answers are arrays.
    """
    ...
    try:
        extracted_info = parse_openai_response(response.choices[0].message.content.strip())
        ...
        for key in ['Education', 'Professional Experience', 'Projects', 'Questions and Answers']:
